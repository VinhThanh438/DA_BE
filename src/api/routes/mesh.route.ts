import { create, update } from '@api/validation/mesh.validator';
import { MeshController } from '@api/controllers/mesh.controller';
import { validateRequest } from '@api/middlewares/validate.middleware';
import { queryById, queryFilter } from '@api/validation/common.validator';
import express from 'express';

const router = express.Router();
const controller = MeshController.getInstance();
