import { FinanceRecordController } from '@api/controllers/finance-record.controller';
import { validateRequest } from '@api/middlewares/validate.middleware';
import { queryById, queryFilter } from '@api/validation/common.validator';
import { create, update } from '@api/validation/finance-record.validator';
import express from 'express';

const router = express.Router();
const controller = FinanceRecordController.getInstance();
