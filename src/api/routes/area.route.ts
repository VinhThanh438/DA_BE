import { AreaController } from '@api/controllers/area.controller';
import { queryById, queryFilter } from '@api/validation/common.validator';
import { validateRequest } from '@api/middlewares/validate.middleware';
import { create, update } from '@api/validation/area.validator';
import express from 'express';

const router = express.Router();
const controller = AreaController.getInstance();
