import { JobPositionController } from '@api/controllers/job-position.controller';
import { validateRequest } from '@api/middlewares/validate.middleware';
import { queryById } from '@api/validation/common.validator';
import { create, update } from '@api/validation/job-position.validator';
import express from 'express'

const router = express.Router()
const controller = JobPositionController.getInstance();
