import { OrderExpenseController } from '@api/controllers/order-expense.controller';
import { validateRequest } from '@api/middlewares/validate.middleware';
import { queryById } from '@api/validation/common.validator';
import { create, queryFilter, update } from '@api/validation/order-expense.validator';
import express from 'express';

const router = express.Router();
const controller = OrderExpenseController.getInstance();
