...
import { InventoryDetailSelection, InventoryDetailSelectionAll } from './prisma/inventory-detail.select';
...
> {
    protected db = DatabaseAdapter.getInstance().inventoryDetails;
