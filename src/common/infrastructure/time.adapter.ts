...
export class TimeAdapter {
    ...
    private static dateFormats: string[] = ['YYYY-M-D', 'YYYY-MM-DD', 'YYYY/M/D', 'YYYY/MM/DD'];
    ...
    public static parseDay(date: Date | string): Moment {
        ...
        return moment.tz(date, this.timezone).startOf('day');
    }
    ...
    public static parseStartOfDayDate(date: string): Date {
        return moment.utc(date).startOf('day').toDate();
    }

    public static parseEndOfDayDate(date: string): Date {
    ...
    public static toISOStringUTC(date: Date | string): string {
