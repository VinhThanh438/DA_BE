export const EVENT_TOKEN_EXPIRED = 'event-token-expired';
...
export const EVENT_CREATE_GATELOG = 'event-create-gatelog';

export const EVENT_INVOICE_CREATED = 'event-invoice-created';

export const EVENT_LOAN_CREATED = 'event-loan-created';

export const EVENT_INTEREST_LOG_PAID = 'event-interest-log-paid';
