...
exports.exportMaterialPDF = void 0;
const app_constant_1 = require("../../config/app.constant");
const exportMaterialPDF = (data) => {
    return `<html lang="en">
  <head>
    <meta charset="UTF-8" />
    ...
    <div id="order">
      ...
      >
        ...
        <div style="display: flex; align-items: left; flex-direction: column">
          ...
          <p style="font-size: 12px">Địa chỉ: ${data.address || ''}</p>
          <p style="font-size: 12px">${data.contact || ''}</p>
          <p style="font-size: 12px">MST: ${data.tax_code || ''}</p>
      ...
      <div style="padding: 0 20px">
        ...
        <div>
          <p style="text-align: center; font-size: 28px">PHIẾU XUẤT VẬT TƯ</p>
        </div>
...
exports.exportMaterialPDF = exportMaterialPDF;
