...
exports.production3PDF = void 0;
const app_constant_1 = require("../../config/app.constant");
const production3PDF = (data) => {
    return `<html lang="en">
  <head>
    <meta charset="UTF-8" />
    ...
    <div id="order">
      ...
      >
        ...
        <div style="width: 45%">
          ...
          <p style="text-align: center; font-size: 10px; color: red">
            Đơn hàng thương mại và những sản phẩm chưa phân vào đâu
          </p>
      ...
      <table style="width: 100%">
        <tr>
          ...
          <th colspan="4" rowspan="2">Quy cách</th>
...
exports.production3PDF = production3PDF;
