...
class QuotationRepo extends base_repo_1.BaseRepo {
    constructor() {
        super(...arguments);
        this.db = database_adapter_1.DatabaseAdapter.getInstance().getClient().quotations;
        this.defaultSelect = prisma_select_1.QuotationSelection;
        this.detailSelect = prisma_select_1.QuotationSelectionAll;
        this.modelKey = 'quotations';
    ...
    paginate(_a, includeRelations) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const customWhere = Object.assign(Object.assign({}, ((supplierIds === null || supplierIds === void 0 ? void 0 : supplierIds.length) && {
