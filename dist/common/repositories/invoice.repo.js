...
class InvoiceRepo extends base_repo_1.BaseRepo {
    constructor() {
        super(...arguments);
        this.db = database_adapter_1.DatabaseAdapter.getInstance().getClient().invoices;
        this.defaultSelect = prisma_select_1.InvoiceSelectionWithTotal;
        this.detailSelect = prisma_select_1.InvoiceSelectionAll;
        this.modelKey = 'invoices';
        this.timeFieldDefault = 'invoice_date';
    ...
    paginate(_a, includeRelations) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const customSelect = {
                details: {
                    where: Object.assign({}, ((productIds === null || productIds === void 0 ? void 0 : productIds.length) && { order_detail: { product_id: { in: productIds } } })),
                    select: prisma_select_1.InvoiceDetailSelectionAll,
                },
            };
