...
class OrderRepo extends base_repo_1.BaseRepo {
    constructor() {
        super(...arguments);
        this.db = database_adapter_1.DatabaseAdapter.getInstance().getClient().orders;
        this.defaultSelect = prisma_select_1.OrderSelection;
        this.detailSelect = prisma_select_1.OrderSelectionAll;
        this.modelKey = 'orders';
    ...
    paginate(_a, includeRelations) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _b = args, { productIds, employeeIds, supplierIds } = _b, restQuery = __rest(_b, ["productIds", "employeeIds", "supplierIds"]);
