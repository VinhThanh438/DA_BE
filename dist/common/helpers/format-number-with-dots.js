...
exports.formatNumberWithDots = void 0;
exports.convertMoneyText = convertMoneyText;
...
const bigNumbers = ['', 'nghìn', 'triệu', 'tỷ', 'nghìn tỷ', 'triệu tỷ'];
const formatNumberWithDots = (number) => {
    return number.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',');
};
exports.formatNumberWithDots = formatNumberWithDots;
function readThreeDigits(num, isFirst = false, hasNextGroup = false) {
...
function convertMoneyText(number) {
    if (number === 0)
        return 'không đồng';
    if (number < 0)
        return 'âm ' + convertMoneyText(-number);
    // Xử lý số quá lớn
