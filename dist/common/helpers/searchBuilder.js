...
class PrismaSearchBuilder {
     ...
     */
    static buildSearch(keyword, fields = [], options = { mode: 'insensitive', useAnd: true, searchStrategy: 'exact', useUnaccent: true }) {
     ...
     */
    static buildExactSearch(keyword, fields = [], options = { mode: 'insensitive', useAnd: true }) {
     ...
     */
    static buildFuzzySearch(keyword, fields = [], options = { mode: 'insensitive', useAnd: true }) {
     ...
     */
    static buildCharacterSearch(keyword, fields = [], options = { mode: 'insensitive', useAnd: true }) {
        return this.buildFuzzySearch(keyword || '', fields, options);
    }
    /**
     ...
     */
    static buildObjectFieldCondition(field, searchValue, mode) {
        const condition = {};
     ...
     */
    static buildArrayFieldCondition(field, searchValue, mode) {
        const condition = {};
        let current = condition;
     ...
     * @returns Prisma where condition object
     */
    static combineConditions(conditions, operator = 'AND') {
...
exports.default = PrismaSearchBuilder;
