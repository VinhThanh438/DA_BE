...
exports.HandleLoanPaymentJob = void 0;
...
class HandleLoanPaymentJob extends base_job_1.BaseJob {
    constructor() {
        super();
        this.queueName = job_constant_1.HANDLE_LOAN_PAYMENT_JOB;
    ...
    handler(job) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield this.loanService.handleLoanPayment(job.data);
...
exports.HandleLoanPaymentJob = HandleLoanPaymentJob;
