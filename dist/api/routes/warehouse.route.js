...
const warehouse_validator_1 = require("../validation/warehouse.validator");
const express_1 = __importDefault(require("express"));
const router = express_1.default.Router();
const controller = warehouse_controller_1.WarehouseController.getInstance();
...
router.post('/', (0, validate_middleware_1.validateRequest)(warehouse_validator_1.createAndUpdate), spatial_classification_middleware_1.SpatialClassificationMiddleware.assignInfoToRequest, controller.create.bind(controller));
router.put('/:id', (0, validate_middleware_1.validateRequest)(warehouse_validator_1.createAndUpdate), controller.update.bind(controller));
