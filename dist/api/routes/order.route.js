...
const order_validator_1 = require("../validation/order.validator");
const express_1 = __importDefault(require("express"));
const router = express_1.default.Router();
const controller = order_controller_1.OrderController.getInstance();
router.get('/', (0, validate_middleware_1.validateRequest)(order_validator_1.queryFilter), controller.paginate.bind(controller));
...
router.post('/', (0, validate_middleware_1.validateRequest)(order_validator_1.create), spatial_classification_middleware_1.SpatialClassificationMiddleware.assignInfoToRequest, controller.create.bind(controller));
...
router.put('/:id', (0, validate_middleware_1.validateRequest)(order_validator_1.update), controller.updateOrder.bind(controller));
