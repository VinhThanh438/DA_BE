...
const product_history_controller_1 = require("../controllers/product-history.controller");
const validate_middleware_1 = require("../middlewares/validate.middleware");
const common_validator_1 = require("../validation/common.validator");
const express_1 = __importDefault(require("express"));
const router = express_1.default.Router();
const controller = product_history_controller_1.ProductHistoryController.getInstance();
