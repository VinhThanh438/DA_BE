...
const position_validator_1 = require("../validation/position.validator");
const express_1 = __importDefault(require("express"));
const router = express_1.default.Router();
const controller = position_controller_1.PositionController.getInstance();
...
router.post('/', (0, validate_middleware_1.validateRequest)(position_validator_1.create), spatial_classification_middleware_1.SpatialClassificationMiddleware.assignInfoToRequest, controller.create.bind(controller));
router.put('/:id', (0, validate_middleware_1.validateRequest)(position_validator_1.update), controller.update.bind(controller));
