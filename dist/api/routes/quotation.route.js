...
const controller = quotation_controller_1.QuotationController.getInstance();
router.get('/', (0, validate_middleware_1.validateRequest)(quotation_validator_1.queryFilter), controller.paginate.bind(controller));
...
router.post('/', (0, validate_middleware_1.validateRequest)(quotation_validator_1.create), controller.create.bind(controller));
router.put('/:id', (0, validate_middleware_1.validateRequest)(quotation_validator_1.update), controller.update.bind(controller));
