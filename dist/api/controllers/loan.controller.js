...
class LoanController extends base_controller_1.BaseController {
    constructor() {
        super(loan_service_1.LoanService.getInstance());
        this.service = loan_service_1.LoanService.getInstance();
    }
    static getInstance() {
        if (!this.instance) {
